...
<template>
    <Layout>
        <div class="grid">
            ...
            <section class='dark:bg-gray-900 bg-gray-100 border-1 border-gray-500 dark:border-gray-500 p-8 my-4'>
                <p>
            ...
            <section class='dark:bg-gray-900 bg-gray-100 border-gray-500 border-1 dark:border-gray-500 p-8 my-4'>
                <div>
                    <div class='flex flex-row justify-between items-center mb-2'>
                        <h3>Software Developer | Database Admin</h3>
            ...
            <section class='dark:bg-gray-900 bg-gray-100 border-gray-500 border-1 dark:border-gray-500 p-8 my-4 flex flex-col'>
                <h3 class="self-center">Languages</h3>
            ...
            <section class='dark:bg-gray-900 bg-gray-100 border-1 dark:border-gray-500 border-gray-500 p-8 my-4 flex flex-col'>
                <h3 class="self-center">Frameworks and Others</h3>
                <div class="flex flex-row items-center justify-between gap-4">
                    <div>
            ...
            <section>
                <div class="flex gap-4 my-4">
                    ...
                    <!-- Personal Website -->
                    <div class='dark:bg-gray-900 bg-gray-100 border-1 dark:border-gray-500 border-gray-500 p-4'>
                    ...
                    <!-- Recipe Website -->
                    <div class=' dark:bg-gray-900 bg-gray-100 border-1 dark:border-gray-500 border-gray-500 p-4 row-start-2'>
                    ...
                    <!-- Ludum Dare -->
                    <div class='dark:bg-gray-900 bg-gray-100 border-1 dark:border-gray-500 border-gray-500 p-4 row-span-2 col-start-2'>   
            ...
            <section class='dark:bg-gray-900 bg-gray-100 border-1 dark:border-gray-500 border-gray-500 p-8 my-4'>
